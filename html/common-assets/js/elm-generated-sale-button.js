...
var $author$project$LinkToSaleButtonOrCountdown$init = function (flags) {
	return _Utils_Tuple2(
		{
			now: $author$project$Helpers$Time$secondsToPosix(flags.now),
			saleStartTime: $author$project$Helpers$Time$secondsToPosix(flags.saleStartTime)
		},
		$elm$core$Platform$Cmd$none);
};
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $author$project$LinkToSaleButtonOrCountdown$UpdateNow = function (a) {
...
var $author$project$LinkToSaleButtonOrCountdown$subscriptions = function (model) {
	return A2($elm$time$Time$every, 500, $author$project$LinkToSaleButtonOrCountdown$UpdateNow);
};
var $elm$browser$Browser$Navigation$load = _Browser_load;
var $author$project$LinkToSaleButtonOrCountdown$update = F2(
	function (msg, prevModel) {
		if (msg.$ === 'UpdateNow') {
			...
			return _Utils_Tuple2(
				prevModel,
				$elm$browser$Browser$Navigation$load('https://sale.foundrydao.com'));
		}
	});
var $author$project$CommonTypes$Desktop = {$: 'Desktop'};
var $author$project$LinkToSaleButtonOrCountdown$GotoSale = {$: 'GotoSale'};
...
var $author$project$Helpers$Time$toConciseIntervalString = function (t) {
	var hri = $author$project$Helpers$Time$toHumanReadableInterval(t);
	return (hri.days > 0) ? ($elm$core$String$fromInt(hri.days) + ('d ' + ($elm$core$String$fromInt(hri.hours) + 'h'))) : ((hri.hours > 0) ? ($elm$core$String$fromInt(hri.hours) + ('h ' + ($elm$core$String$fromInt(hri.min) + 'm'))) : ((hri.min > 0) ? ($elm$core$String$fromInt(hri.min) + ('m ' + ($elm$core$String$fromInt(hri.sec) + 's'))) : ($elm$core$String$fromInt(hri.sec) + 's')));
};
var $author$project$LinkToSaleButtonOrCountdown$view = function (model) {
	var timeUntilSale = A2($author$project$Helpers$Time$sub, model.saleStartTime, model.now);
	var saleHasStarted = $author$project$Helpers$Time$isNegative(timeUntilSale);
	return A2(
		$mdgriffith$elm_ui$Element$layout,
		_List_Nil,
		saleHasStarted ? A4(
			$author$project$Helpers$Element$redButton,
			$author$project$CommonTypes$Desktop,
			_List_Nil,
			_List_fromArray(
				['Get FRY']),
			$author$project$LinkToSaleButtonOrCountdown$GotoSale) : A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			$mdgriffith$elm_ui$Element$text(
				'Sale begins in ' + $author$project$Helpers$Time$toConciseIntervalString(timeUntilSale))));
};
var $author$project$LinkToSaleButtonOrCountdown$main = $elm$browser$Browser$element(
	{init: $author$project$LinkToSaleButtonOrCountdown$init, subscriptions: $author$project$LinkToSaleButtonOrCountdown$subscriptions, update: $author$project$LinkToSaleButtonOrCountdown$update, view: $author$project$LinkToSaleButtonOrCountdown$view});
_Platform_export({'LinkToSaleButtonOrCountdown':{'init':$author$project$LinkToSaleButtonOrCountdown$main(
	A2(
			...
			return A2(
				...
				function (now) {
					return $elm$json$Json$Decode$succeed(
						{now: now, saleStartTime: saleStartTime});
				},
				A2($elm$json$Json$Decode$field, 'now', $elm$json$Json$Decode$int));
		},
		A2($elm$json$Json$Decode$field, 'saleStartTime', $elm$json$Json$Decode$int)))(0)}});}(this));
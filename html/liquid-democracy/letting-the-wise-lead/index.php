...
<?php include($_SERVER['DOCUMENT_ROOT'] . "/common-assets/html/google-analytics-stuff.php"); ?>
    ...
    <title>Foundry - Letting the Wise Lead the Crowd</title>
    <meta name="description" content="Liquid Democracy allows wise decision makers to gain influence, without needin an explicit manager class.">
</head>
<body>
    <?php
